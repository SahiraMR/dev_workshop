...
class Geometria:
    ...
    """
    def area_poligono_regular(num_lados: int, lado: float) -> float:

      if num_lados < 3 or lado <= 0:
        raise ValueError("El número de lados debe ser mayor o igual a 3 y la longitud del lado debe ser positiva.")
